...
interface BusinessPartnerDetailPersonalizationSettingsProps {
  isOpen: boolean;
  onClose: () => void;
...
const defaultSettings: PersonalizationItem[] = [
  // Header Fields
  { id: "companyName", name: "Company Name", category: "header", enabled: true, description: "Business partner company name" },
  { id: "partnerType", name: "Partner Type", category: "header", enabled: true, description: "Client, vendor, or strategic partner" },
  { id: "industry", name: "Industry", category: "header", enabled: true, description: "Industry sector" },
  { id: "location", name: "Location", category: "header", enabled: true, description: "Company headquarters location" },
  { id: "primaryContact", name: "Primary Contact", category: "header", enabled: true, description: "Main point of contact" },
  
  // Statistics
  { id: "totalRevenue", name: "Total Revenue", category: "statistics", enabled: true, description: "Total revenue generated" },
  { id: "activeJobs", name: "Active Jobs", category: "statistics", enabled: true, description: "Number of current job openings" },
  { id: "placements", name: "Total Placements", category: "statistics", enabled: true, description: "Successful placements made" },
  
  // Tabs
  { id: "overviewTab", name: "Overview Tab", category: "tabs", enabled: true, description: "Partner overview and summary" },
  { id: "contactsTab", name: "Contacts Tab", category: "tabs", enabled: true, description: "Key contacts and stakeholders" },
  { id: "jobsTab", name: "Jobs Tab", category: "tabs", enabled: true, description: "Current and past job postings" },
  
  // Overview Section Fields
  { id: "companyProfile", name: "Company Profile", category: "overview", enabled: true, description: "Company background and description" },
  { id: "keyRequirements", name: "Key Requirements", category: "overview", enabled: true, description: "Typical hiring requirements" },
];

const BusinessPartnerDetailPersonalizationSettings = ({ isOpen, onClose, onSave, currentSettings }: BusinessPartnerDetailPersonalizationSettingsProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-7xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle>Business Partner Detail Personalization Settings</DialogTitle>
        </DialogHeader>
...
export default BusinessPartnerDetailPersonalizationSettings;